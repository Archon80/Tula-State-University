...
function load_pdf_ie(number_chast_vypuska)
{
 ...
 myiframe.src = "pdf/web/download_pdf.php" + "?x=" + number_chast_vypuska;
			...
			function showhide(id_disp,god)
				{
					seriya = "physical_education_sport";
					...
					technikal_2013[1] = begin + href_begin + "tsu_izv_physical_education_sport_2013_01" + href_end_1 + " Выпуск 1" + href_end_2 + end;
					technikal_2013[6] = begin + href_begin + "tsu_izv_physical_education_sport_2013_02" + href_end_1 + " Выпуск 2"  + href_end_2 + end;
					technikal_2013[11] = begin + href_begin + "tsu_izv_physical_education_sport_2013_03" + href_end_1 + " Выпуск 3"  + href_end_2 + end;
					...
					technikal_2014[1] = begin + href_begin + "tsu_izv_physical_education_sport_2014_01" + href_end_1 + " Выпуск 1"  + href_end_2 + end;
					technikal_2014[6] = begin + href_begin + "tsu_izv_physical_education_sport_2014_02" + href_end_1 + " Выпуск 2"  + href_end_2 + end;
					technikal_2014[11] = begin + href_begin + "tsu_izv_physical_education_sport_2014_03" + href_end_1 + " Выпуск 3"  + href_end_2 + end;
					...
					technikal_2015[1] = begin + href_begin + "tsu_izv_physical_education_sport_2015_01" + href_end_1 + " Выпуск 1"  + href_end_2 + end;
					technikal_2015[6] = begin + href_begin + "tsu_izv_physical_education_sport_2015_02" + href_end_1 + " Выпуск 2"  + href_end_2 + end;
...
function jurnal()		
{
	...
	jurnal[0] = status_jurnal("актуальный","2013");
	jurnal[1] = status_jurnal("актуальный","2014");
	jurnal[2] = status_jurnal("актуальный","2015");

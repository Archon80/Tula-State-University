 ...
 myiframe.src = "pdf/web/download_pdf.php" + "?x=" + number_chast_vypuska;
	...
	function showhide(id_disp,god)
	{
		...
		if (god == "2008")
		{
			...
			technikal_2008[1] = begin + href_begin + "tsu_izv_humanities_2008_01" + href_end_1 + " Выпуск 1" + href_end_2 + end;
			technikal_2008[6] = begin + href_begin + "tsu_izv_humanities_2008_02" + href_end_1 + " Выпуск 2" + href_end_2 + end;
		...
		if (god == "2009")
		{
			...
			technikal_2009[1] = begin + href_begin + "tsu_izv_humanities_2009_01" + href_end_1 + " Выпуск 1" + href_end_2 + end;
			technikal_2009[6] = begin + href_begin + "tsu_izv_humanities_2009_02" + href_end_1 + " Выпуск 2" + href_end_2 + end;
			technikal_2009[11] = begin_ziro + " " + end;
		...
		if (god == "2010")
		{
			...
			technikal_2010[1] = begin + href_begin + "tsu_izv_humanities_2010_01" + href_end_1 + " Выпуск 1" + href_end_2 + end;
			technikal_2010[6] = begin + href_begin + "tsu_izv_humanities_2010_02" + href_end_1 + " Выпуск 2" + href_end_2 + end;
		...
		if (god == "2011")
		{
			...
			technikal_2011[1] = begin + href_begin + "tsu_izv_humanities_2011_01" + href_end_1 + " Выпуск 1" + href_end_2 + end;
			technikal_2011[6] = begin + href_begin + "tsu_izv_humanities_2011_02" + href_end_1 + " Выпуск 2" + href_end_2 + end;
			technikal_2011[11] = begin + href_begin + "tsu_izv_humanities_2011_03_part_1" + href_end_1 + " Выпуск 3 (Часть 1)" + href_end_2 + end;
			technikal_2011[16] = begin + href_begin + "tsu_izv_humanities_2011_03_part_2" + href_end_1 + " Выпуск 3 (Часть 2)" + href_end_2 + end;
		...
		if (god == "2012")
		{
			...
			technikal_2012[1] = begin + href_begin + "tsu_izv_humanities_2012_01_part_1" + href_end_1 + " Выпуск 1 (Часть 1)" + href_end_2 + end;
			technikal_2012[6] = begin + href_begin + "tsu_izv_humanities_2012_01_part_2" + href_end_1 + " Выпуск 1 (Часть 2)" + href_end_2 + end;
			technikal_2012[11] = begin + href_begin + "tsu_izv_humanities_2012_02" + href_end_1 + " Выпуск 2" + href_end_2 + end;
			technikal_2012[16] = begin + href_begin + "tsu_izv_humanities_2012_03" + href_end_1 + " Выпуск 3" + href_end_2 + end;
		...
		if (god == "2013")
		{
			...
			technikal_2013[1] = begin + href_begin + "tsu_izv_humanities_2013_01" + href_end_1 + " Выпуск 1" + href_end_2 + end;
			technikal_2013[6] = begin + href_begin + "tsu_izv_humanities_2013_02" + href_end_1 + " Выпуск 2" + href_end_2 + end;
			technikal_2013[11] = begin + href_begin + "tsu_izv_humanities_2013_03_part_1" + href_end_1 + " Выпуск 3 (Часть 1)" + href_end_2 + end;
			technikal_2013[16] = begin + href_begin + "tsu_izv_humanities_2013_03_part_2" + href_end_1 + " Выпуск 3 (Часть 2)" + href_end_2 + end;
			technikal_2013[5] = radelitel;
			technikal_2013[2] = begin + href_begin + "tsu_izv_humanities_2013_04" + href_end_1 + " Выпуск 4" + href_end_2 + end;
		...
		if (god == "2014")
		{
			...
			technikal_2014[1] = begin + href_begin + "tsu_izv_humanities_2014_01" + href_end_1 + " Выпуск 1" + href_end_2 + end;
			technikal_2014[6] = begin + href_begin + "tsu_izv_humanities_2014_02" + href_end_1 + " Выпуск 2" + href_end_2 + end;
			technikal_2014[11] = begin + href_begin + "tsu_izv_humanities_2014_03" + href_end_1 + " Выпуск 3" + href_end_2 + end;
			technikal_2014[16] = begin + href_begin + "tsu_izv_humanities_2014_04_part_1" + href_end_1 + " Выпуск 4 (Часть 1)" + href_end_2 + end;
			technikal_2014[5] = radelitel;
			technikal_2014[2] = begin + href_begin + "tsu_izv_humanities_2014_04_part_2" + href_end_1 + " Выпуск 4 (Часть 2)" + href_end_2 + end;
			...
			if (god == "2015")
				...
				technikal_2015[1] = begin + href_begin + "tsu_izv_humanities_2015_01" + href_end_1 + " Выпуск 1" + href_end_2 + end;
				technikal_2015[6] = begin + href_begin + "tsu_izv_humanities_2015_02" + href_end_1 + " Выпуск 2" + href_end_2 + end;
